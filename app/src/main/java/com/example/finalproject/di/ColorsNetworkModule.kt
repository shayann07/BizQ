package com.example.finalproject.data.di
...
object ColorNetworkModule {
    ...
    @Provides @Singleton
    fun provideColorRetrofit(client: OkHttpClient, moshi: Moshi): Retrofit =
        Retrofit.Builder()
    ...
    @Provides @Singleton
    fun provideColorApi(retrofit: Retrofit): ColorApiService =
